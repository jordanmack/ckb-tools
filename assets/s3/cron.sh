...
nice -n 19 7z a -r -mmt=4 -mx9 $filename1 /home/nervos/ckbt/data/db/*
sleep 1
...
#nice -n 19 7z a -r -mmt=4 -mx9 $filename2 /home/nervos/ckb-indexer/testnet-data/*
#sleep 1
...
aws s3 cp --no-progress $filename1 s3://cdn-ckb-tools/snapshots/ --acl public-read --endpoint=https://sfo3.digitaloceanspaces.com --profile=digitalocean
#aws s3 cp --no-progress $filename2 s3://cdn-ckb-tools/snapshots/ --acl public-read --endpoint=https://sfo3.digitaloceanspaces.com --profile=digitalocean
sleep 1
