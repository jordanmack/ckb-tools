...
rm -f /home/nervos/ckbt/data/db/LOG.old.*
...
rm -f /home/nervos/ckb-indexer/testnet-data/LOG.old.*
...
rm -f /home/nervos/.ckb-cli/index-v1/0x10639e0895502b5688a6be8cf69460d76541bfa4821629d86d62ba0aae3f9606/LOG.old.*
...
#rm -f /home/nervos/lumos-indexer/testnet-data/LOG.old.*
...
aws s3 cp $filename3 s3://cdn-ckb-tools/snapshots/ --acl public-read --endpoint=https://sfo3.digitaloceanspaces.com --profile=digitalocean
#aws s3 cp $filename4 s3://cdn-ckb-tools/snapshots/ --acl public-read --endpoint=https://sfo3.digitaloceanspaces.com --profile=digitalocean
sleep 1
